...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/img/play_right.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/img/play_left.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/img/fast_play_left.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_fast_left.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/img/pause.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/img/fast_play_right.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.pushButton_fast_right.setIcon(icon4)
        ...
        self.comboBox_speed.setMinimumSize(QtCore.QSize(122, 0))
        self.comboBox_speed.setMaximumSize(QtCore.QSize(122, 16777215))
        font = QtGui.QFont()
        font.setFamily("Cascadia Code")
        font.setPointSize(12)
        self.comboBox_speed.setFont(font)
        self.comboBox_speed.setFocusPolicy(QtCore.Qt.NoFocus)
        self.comboBox_speed.setCurrentText("")
        self.comboBox_speed.setObjectName("comboBox_speed")
        self.gridLayout_2.addWidget(self.comboBox_speed, 0, 1, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem, 0, 3, 1, 1)
        self.pushButton_save = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_save.setMinimumSize(QtCore.QSize(45, 45))
        self.pushButton_save.setMaximumSize(QtCore.QSize(45, 45))
        ...
        self.gridLayout_2.addWidget(self.pushButton_save, 0, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.video_time_label, 0, 2, 1, 1)
        self.pushButton_output_dir = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_output_dir.setMinimumSize(QtCore.QSize(45, 45))
        self.pushButton_output_dir.setMaximumSize(QtCore.QSize(45, 45))
        self.pushButton_output_dir.setFocusPolicy(QtCore.Qt.NoFocus)
        self.pushButton_output_dir.setText("")
        self.pushButton_output_dir.setIconSize(QtCore.QSize(30, 30))
        self.pushButton_output_dir.setObjectName("pushButton_output_dir")
        self.gridLayout_2.addWidget(self.pushButton_output_dir, 0, 4, 1, 1)
